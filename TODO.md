...
- [ ] **13. Automatic references binder** — Component passed to bootstrap context that auto-binds all referenced GameObjects (prefabs, ScriptableObjects, etc.). Eliminates manual binding of asset references.
